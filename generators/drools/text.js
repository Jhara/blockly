...
goog.provide('Blockly.Drools.texts');
...
Blockly.Drools['text_changeCase'] = function(block) {
  ...
  if (operator) {
    ...
    var functionName = Blockly.Drools.provideFunction_(
        'text_toTitleCase',
        [ 'function ' +
            Blockly.Drools.FUNCTION_NAME_PLACEHOLDER_ + '(str) {',
...
Blockly.Drools['text_prompt_ext'] = function(block) {
  // Prompt function (external message).
  var msg = Blockly.Drools.valueToCode(block, 'TEXT',
      Blockly.Drools.ORDER_NONE) || '\'\'';
  var code = 'window.prompt(' + msg + ')';
  var toNumber = block.getFieldValue('TYPE') == 'NUMBER';
  if (toNumber) {
